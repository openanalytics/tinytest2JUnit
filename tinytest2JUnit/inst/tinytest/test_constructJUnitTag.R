...
#  testresults <- tinytest::run_test_dir(file.path(system.file("example_tests", package = "tinytest2JUnit"), "empty_test_folder"), verbose = F)
  ...
  expect_equal(targ$content[[1]]$attributes, list(name = "test_heavy_calculation.R", tests = 1L, failures = 0L))
  expect_equal(targ$content[[1]]$content[[1]]$attributes, list(name = "test_heavy_calculation.R: L16", status = "PASSED"))
  ...
  expect_equal(targ$content[[1]]$name, "testsuite")
  expect_equal(targ$content[[1]]$attributes, list(name = "test_multiline_except.R", tests = 1L, failures = 1L))
  expect_equal(targ$content[[1]]$content[[1]]$attributes, list(name = "test_multiline_except.R: L9-L15", status = "FAILED"))
  ...
  expect_equal(targ$content[[1]]$content[[1]]$attributes, list(name = "test_file1.R: L9", status = "PASSED"))
  expect_equal(targ$content[[1]]$content[[2]]$attributes, list(name = "test_file1.R: L10", status = "PASSED"))
  expect_equal(targ$content[[2]]$content[[1]]$attributes, list(name = "test_file2.R: L9-L15", status = "FAILED"))
  ...
  expect_true(targ$attributes$failures == 1L)
  expect_equal(targ$content[[1]]$name, "testsuite")
  expect_equal(targ$content[[1]]$attributes, list(name = "test_addition.R", tests = 4L, failures = 1L))
  ...
  expect_true(targ$attributes$tests == 1L)
  expect_equal(targ$content[[1]]$name, "testsuite")
  expect_equal(targ$content[[1]]$attributes, list(name = "test_partial_skipped.R", tests = 1L, failures = 0L))
