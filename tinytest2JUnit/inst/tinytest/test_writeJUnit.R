...
tinytest2JUnit::writeJUnit(tinytests = testresults, file = tmpFile, overwrite = TRUE)
...
expect_error(tinytest2JUnit::writeJUnit(tinytests = testresults, file = tmpFile, overwrite = FALSE),
