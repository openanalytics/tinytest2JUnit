                ...
                stage('tinytest2JUnit') {
                    stages {
                        ...
                        stage('Test and coverage') {
                            steps {
                                dir('tinytest2JUnit') {
                                    sh '''R -q -e \'code <- "tinytest2JUnit::writeJUnit(tinytest::run_test_dir(system.file(\\"tinytest\\", package =\\"tinytest2JUnit\\"), verbose=FALSE), file = file.path(getwd(), \\"results.xml\\"))"
